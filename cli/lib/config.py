...
CHUNK_MANIFEST_PATH = PROCESSED_DATA_DIR / "chunk_manifest.json"
...
MODEL_MAX_SEQUENCE_TOKENS = 256
EMBEDDING_INPUT_MODE = "title_text"
EMBEDDING_TITLE_MAX_TOKENS = 24
EMBEDDING_SAFETY_MARGIN_TOKENS = 8
EMBEDDING_INPUT_TEMPLATE = "Title: {title}\nText: {text}"
EMBEDDING_INPUT_TEMPLATE_VERSION = "title_text_v1"
...
CHUNKING_STRATEGY_VERSION = "token_sentence_v1"
