import argparse
from lib.config import BM25_B, BM25_K1
...
def main() -> None:
    ...
    search_parser = subparsers.add_parser("search", help="Search document chunks using keywords")
    search_parser.add_argument("query", type=str, help="Search query")

    build_parser = subparsers.add_parser("build", help="Build the inverted index")

    tf_parser = subparsers.add_parser("tf", help="Get term frequency for a specific document and term")
    tf_parser.add_argument("doc_id", type=str, help="Chunk ID")
    ...
    tfidf_parser.add_argument("doc_id", type=str, help="Chunk ID")
    ...
    bm25_tf_parser.add_argument("doc_id", type=str, help="Chunk ID")
    bm25_tf_parser.add_argument("term", type=str, help="Term to get BM25 TF score for")
    bm25_tf_parser.add_argument("k1", type=float, nargs="?", default=BM25_K1, help="Tunable BM25 K1 parameter") 
    bm25_tf_parser.add_argument("b", type=float, nargs="?", default=BM25_B, help="Tunable BM25 b parameter")  

    bm25search_parser = subparsers.add_parser("bm25search", help="Search chunks using BM25 scoring")
